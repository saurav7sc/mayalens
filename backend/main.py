...
analysis_cache = {}
CACHE_EXPIRY = 10  # 1 hour in seconds
...
async def analyze_palm_with_openai(image_base64: str) -> Tuple[str, bool]:
    ...
    try:
        ...
        if not response_text or len(response_text) < 50:
            ...
            return get_generic_response(), True
...
#             # Fall through to empty string return
    
#     # For now, return empty audio URL if no audio was generated
#     return ""
